...
import { useGetBucketlistQuery, useUpdateIsCheckedMutation, useCreateBucketlistMutation } from '../slices/bucketlistApiSlice';
  ...
  const handleAddBucketlist = async(e) => {
    ...
    return (
      <>
          ...
          <div className="">
            <ul role="list" className="divide-y divide-gray-200">
              {isLoadingList ? (
                ...
                data?.map((data) => (
                  <li className="py-3 sm:py-4" key={data._id}>
                        ...
                        {editMode ? (
                          ...
                          <>
                            <div className="flex items-center space-x-2">
                              ...
                              <p
                                className={`text-sm font-medium text-gray-900 truncate ${check[data._id] ? 'line-through' : ''}`}
                              >
                                {data.text}
                              </p>
                            </div>
                      ...
                      <div className="inline-flex items-center text-base font-semibold text-gray-900">
                        ...
                        {editMode && (
                          <>
                            ...
                            <button aria-label="Delete" className='ms-2'>
                              <svg
                                stroke="currentColor"
                                fill="currentColor"
                                strokeWidth="0"
        ...
        <div className="flex justify-center items-center mx-auto mt-4 mb-10">
